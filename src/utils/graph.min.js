export class Graph {
  constructor(t) {
    if (
      ...
      'object' != typeof this.options.data &&
    ...
    if (
      ...
      'CANVAS' !== this.options.target.nodeName
    )
      throw new Error('Canvas not defined');
    (this.options.context = this.options.target.getContext(
      '2d'
    )),
      this.init(),
      this.draw();
  ...
  getPointCoordinates(t) {
    return [
      this.options.paddingLeft + t * this.horizontalScale,
      this.middle +
        this.options.paddingTop -
        this.verticalScale * this.options.data[t],
    ];
  }
  init() {
    (this.options.target.height = this.options.target.parentElement.offsetHeight),
      ...
      this.options.showLegend &&
        ((this.options.paddingLeft =
          this.options.paddingLeft ||
          2 * this.options.legendHeight),
        (this.options.paddingRight =
          this.options.paddingRight ||
          2 * this.options.legendHeight),
        (this.options.paddingBottom =
          this.options.paddingBottom ||
          2.5 * this.options.legendHeight)),
      this.options.showBounds &&
        ((this.options.paddingLeft =
          this.options.paddingLeft ||
          this.options.boundsHeight / 1.4),
        (this.options.paddingTop =
          this.options.paddingTop ||
          1.4 * this.options.boundsHeight),
        (this.options.paddingBottom =
          this.options.paddingBottom ||
          1.4 * this.options.boundsHeight)),
      this.options.showCircle &&
        ((this.options.paddingRight =
          this.options.paddingRight ||
        ...
        (this.options.paddingBottom =
          ...
          this.options.circleSize)),
      (this.options.paddingTop =
        this.options.paddingTop || this.options.lineWidth),
      (this.options.paddingBottom =
        this.options.paddingBottom ||
  ...
  async computeScale() {
    (this.maxValue = Math.abs(
      Math.max(...this.options.data)
    )),
      (this.minValue = Math.abs(
        Math.min(...this.options.data)
      )),
      ...
      (this.horizontalScale =
        this.width / (this.options.data.length - 1)),
      this.options.centerZero ||
      this.maxValue == this.minValue
        ? ((this.middle = Math.round(this.height / 2)),
          (this.verticalScale = this.middle / this.max))
        : ((this.verticalScale =
            this.height / (this.maxValue - this.minValue)),
          (this.middle = Math.round(
            this.maxValue * this.verticalScale
          )));
  }
  async drawMiddle() {
    this.options.showZeroLine &&
  ...
  async drawData() {
    const t = this.options.data.length - 1;
  ...
  async drawCircle() {
    ...
    const t = this.getPointCoordinates(
  ...
  async drawBounds() {
    ...
    const t = this.options.centerZero
        ? this.max
        : this.maxValue,
      i = this.options.centerZero
        ? -this.max
        : this.minValue;
    (this.options.context.font =
      this.options.boundsHeight +
      'px ' +
      this.options.boundsFont),
